...
key = os.environ.get("SUPABASE_KEY")  # Service Role Key preferred for seeding
supabase = create_client(url, key)

BLOOD_TYPES = ["A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"]
SEXES = ["Male", "Female"]
ISLANDS = ["Male'", "Hulhumale'", "Villingili", "Addu", "Fuvahmulah", "Kulhudhuffushi", "Thinadhoo", "Naifaru"]
